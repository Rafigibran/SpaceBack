...
public class UpdateViewActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_UpNew_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				textview6.setText(_childValue.get("Description").toString());
				Proses.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View _view) {
						SketchwareUtil.showMessage(getApplicationContext(), "Unduhan dimulai");
						_Pre_Downloader(_childValue.get("Link").toString(), "SpaceBack v".concat(_childValue.get("recent_version").toString().concat(".apk")));
					}
				});
			}
	...
	private void initializeLogic() {
		...
		downloadDirectory = FileUtil.getPublicDir(Environment.DIRECTORY_DOWNLOADS);
	...
	public static class AppDbHelper implements DbHelper {
			...
			public AppDbHelper(android.content.Context context) {
	...
	public static class ProgressHandler extends android.os.Handler {
	...
	public static class DefaultHttpClient implements HttpClient {
			...
			public java.io.InputStream getErrorStream() {
					if (connection instanceof java.net.HttpURLConnection) {
							return ((java.net.HttpURLConnection) connection).getErrorStream();
					}
					return null;
			}
	...
	*/
	...
	public static class ComponentHolder {
			...
			public void init(android.content.Context context, PRDownloaderConfig config) {
	...
	public static class DownloadTask {
			...
			private String convertStreamToString(java.io.InputStream stream) {
					StringBuilder stringBuilder = new StringBuilder();
					if (stream != null) {
							String line;
							java.io.BufferedReader bufferedReader = null;
							try {
									bufferedReader = new java.io.BufferedReader(new java.io.InputStreamReader(stream));
									...
									} catch (NullPointerException | java.io.IOException ignored) {
		...
		try {
			...
			.setOnProgressListener(new OnProgressListener() {
				...
				public void onProgress(Progress _progress) {
					...
					if (totalBytes != -1) {
						...
						waveProgressbar.setProgress((int)download_progress);
					}
					else {
			...
			.start(new OnDownloadListener() {
				...
				public void onDownloadComplete() {
					...
					waveProgressbar.setProgress((int)0);
					SketchwareUtil.showMessage(getApplicationContext(), "Download Selesai, tersimpan di folder Download");
				}
				 @Override
